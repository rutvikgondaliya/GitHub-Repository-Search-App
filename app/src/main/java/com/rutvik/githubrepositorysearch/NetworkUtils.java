package com.rutvik.githubrepositorysearch;
...
public class NetworkUtils {
    ...
    private static URL buildUrl(String gitHubSearchQuery){
        Uri buildUri = Uri.parse(GITHUB_BASE_URL).buildUpon().appendQueryParameter(PARAM_QUERY, gitHubSearchQuery).appendQueryParameter(PARAM_SORT, SORT_BY).build();
